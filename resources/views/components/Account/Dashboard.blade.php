...
<div class="app-container">
  <div class="sidebar">
    ...
    <ul class="sidebar-list">
      <li class="sidebar-list-item {{ !request('p') ? 'active' : '' }} ">
        <a href="/My-Account">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
          <span>Home</span>
        </a>
      </li>
      <li class="sidebar-list-item {{ request('p') == 'Products' ? 'active' : '' }}">
        <a href="?p=Products">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
          <span>Your Products</span>
        </a>
      </li>
      <li class="sidebar-list-item {{ request('p') == 'New_Password' ? 'active' : '' }}">
        <a href="?p=New_Password">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
  ...
  <div class="app-content">
    <div class="app-content-header">
      ...
      <form action="/logout" method="post">
        @csrf
        <button type="submit" class="app-content-headerButton">Log out</button>
    ...
    <div class="app-content-actions">
      ...
      <div class="app-content-actions-wrapper">
        <div class="filter-button-wrapper">
          <input class="action-button filter jsFilter" type="hidden">
    ...
    @endphp
    <x-Account.Products :product="$user->favourites" path="/My-Account/Delete/" />

    @elseif(request('p') == 'New_Password')
      <x-Account.New_Password />
    @else
      <h1 class="text-blue-500 mt-12" style="text-align: center">Hello {{ auth()->user()->name }}</h1>
    @endif
  </div>
</div>
<!-- partial -->
